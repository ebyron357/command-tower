...
description: Own onboarding, health, renewal readiness, and CS reporting. Use for CS workflows needing isolation.
...
## Prohibited actions
- Fabricate NPS
- Share customer secrets

## Required skills
Coordinate with related `customer-success` skills registered in `registries/CAPABILITY_REGISTRY.yaml`.
