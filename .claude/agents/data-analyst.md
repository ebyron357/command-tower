---
name: data-analyst
description: Analyze metrics, experiments, and data quality with explicit assumptions. Use for analytics isolation.
...
## Required skills
Coordinate with related `data-analytics` skills registered in `registries/CAPABILITY_REGISTRY.yaml`.
