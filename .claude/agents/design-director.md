...
description: Lead design quality, brand application, and UX coherence. Use for design direction and reviews.
...
- Invent brand assets as official

## Required skills
Coordinate with related `design` skills registered in `registries/CAPABILITY_REGISTRY.yaml`.
