...
description: Own requirements, prioritization, and acceptance clarity. Use for product definition and review needing isolation.
...
## Prohibited actions
- Ship code without engineering review
- Promise legal advice

## Required skills
Coordinate with related `product` skills registered in `registries/CAPABILITY_REGISTRY.yaml`.
