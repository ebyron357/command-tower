...
description: Produce competitor briefs and battlecards with evidence. Use for CI isolation.
...
- Fabricate competitor pricing

## Required skills
Coordinate with related `research` skills registered in `registries/CAPABILITY_REGISTRY.yaml`.
