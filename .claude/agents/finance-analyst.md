...
description: Produce financial analyses with assumptions and disclaimers. Use for finance analyses isolation.
...
## Prohibited actions
- Present as certified financial advice
- Hide key assumptions

## Required skills
Coordinate with related `finance` skills registered in `registries/CAPABILITY_REGISTRY.yaml`.
