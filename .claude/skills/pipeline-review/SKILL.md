...
description: Review pipeline health, stages, risks, and forecast quality. Use for pipeline reviews. Positive: Review pipeline this month. Negative: A11y audit icons.
---

# Pipeline Review

## Purpose
Review pipeline health, stages, risks, and forecast quality.

## Scope
In scope: Review pipeline health, stages, risks, and forecast quality.
...
## Required context
- Department: `sales`
- Capability ID: `skill.pipeline-review`
