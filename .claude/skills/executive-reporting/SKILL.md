...
description: Produce concise executive reports with outcomes, metrics, risks, and asks. Use when writing exec reports, board-style summaries, or leadership updates. Positive: Write weekly exec report; Summarize for leadership. Negative: Generate TypeScript types.
---
...
## Scope
In scope: Produce concise executive reports with outcomes, metrics, risks, and asks.
...
- Capability ID: `skill.executive-reporting`
