---
name: unit-economics
description: Analyze unit economics and contribution margins. Use for unit economics. Positive: Analyze CAC/LTV. Negative: Design empty state.
---
...
## Scope
In scope: Analyze unit economics and contribution margins.
...
## Required context
- Department: `finance`
- Capability ID: `skill.unit-economics`
