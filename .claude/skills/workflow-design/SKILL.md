...
description: Design workflows with queues, SLAs, and interfaces. Use for workflow design. Positive: Design intake workflow. Negative: Tune SQL.
---

# Workflow Design

## Purpose
Design workflows with queues, SLAs, and interfaces.

## Scope
In scope: Design workflows with queues, SLAs, and interfaces.
...
- Capability ID: `skill.workflow-design`
