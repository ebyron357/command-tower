---
name: role-design
description: Design roles with outcomes, scope, and success signals. Use for role design. Positive: Design Staff Engineer role. Negative: Write SQL.
---

# Role Design

## Purpose
Design roles with outcomes, scope, and success signals.

## Scope
In scope: Design roles with outcomes, scope, and success signals.
...
- Capability ID: `skill.role-design`
