...
description: Synthesize conflicting evidence into calibrated conclusions. Use for evidence synthesis. Positive: Synthesize conflicting vendor claims. Negative: Bump package.
---

# Evidence Synthesis

## Purpose
Synthesize conflicting evidence into calibrated conclusions.

## Scope
In scope: Synthesize conflicting evidence into calibrated conclusions.
...
## Required context
- Department: `research`
- Capability ID: `skill.evidence-synthesis`
...
## Positive examples
- Synthesize conflicting vendor claims
