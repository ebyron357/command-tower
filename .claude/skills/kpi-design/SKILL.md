---
name: kpi-design
description: Design KPI trees with definitions and anti-gaming notes. Use for KPI design. Positive: Design activation KPIs. Negative: Patch nginx.
---

# Kpi Design

## Purpose
Design KPI trees with definitions and anti-gaming notes.

## Scope
In scope: Design KPI trees with definitions and anti-gaming notes.
...
- Capability ID: `skill.kpi-design`
