...
description: Plan renewals with value proof, risks, expansion options. Use for renewals. Positive: Plan Acme renewal. Negative: Write unit test.
---

# Renewal Planning

## Purpose
Plan renewals with value proof, risks, expansion options.

## Scope
In scope: Plan renewals with value proof, risks, expansion options.
...
- Capability ID: `skill.renewal-planning`
