...
description: Verify claimed completion against evidence gates and remaining work. Use when auditing whether work is actually complete. Positive: Is this feature done?; Completion audit for the OS build. Negative: Brainstorm brand names.
---
...
## Scope
In scope: Verify claimed completion against evidence gates and remaining work.
...
- Capability ID: `skill.completion-review`
...
- Completion audit for the OS build
