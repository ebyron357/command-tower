...
description: Scout technologies with fit, maturity, and risk. Use for tech scouting. Positive: Scout vector DBs. Negative: Write farewell email.
---

# Technology Scouting

## Purpose
Scout technologies with fit, maturity, and risk.

## Scope
In scope: Scout technologies with fit, maturity, and risk.
...
## Required context
- Department: `research`
- Capability ID: `skill.technology-scouting`
