---
name: discovery-prep
description: Prepare discovery agendas, questions, and hypotheses. Use for discovery prep. Positive: Prep discovery for FinTech SMB. Negative: Run load test.
---

# Discovery Prep

## Purpose
Prepare discovery agendas, questions, and hypotheses.

## Scope
In scope: Prepare discovery agendas, questions, and hypotheses.
...
## Required context
- Department: `sales`
- Capability ID: `skill.discovery-prep`
...
## Positive examples
- Prep discovery for FinTech SMB
