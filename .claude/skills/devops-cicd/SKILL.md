---
name: devops-cicd
description: Design CI/CD pipelines, environments, and release automation safely. Use for pipelines, deploy strategy, environment design. Positive: Design GitHub Actions CI; Add preview deploys. Negative: Draft brand guidelines.
---

# Devops Cicd

## Purpose
Design CI/CD pipelines, environments, and release automation safely.

## Scope
In scope: Design CI/CD pipelines, environments, and release automation safely.
...
- Capability ID: `skill.devops-cicd`
