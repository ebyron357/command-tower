...
description: Write PRDs with problem, users, requirements, non-goals, metrics. Use for PRDs and product specs. Positive: Write a PRD for notifications. Negative: Implement CSS.
---

# Product Requirements

## Purpose
Write PRDs with problem, users, requirements, non-goals, metrics.

## Scope
In scope: Write PRDs with problem, users, requirements, non-goals, metrics.
...
## Required context
- Department: `product`
- Capability ID: `skill.product-requirements`
