---
name: seo-content
description: Plan SEO with intent, structure, and measurement. Use for SEO plans/content briefs. Positive: SEO brief for pricing page. Negative: Rotate IAM keys.
---

# Seo Content

## Purpose
Plan SEO with intent, structure, and measurement.

## Scope
In scope: Plan SEO with intent, structure, and measurement.
...
- Capability ID: `skill.seo-content`
