---
name: copywriting
description: Write persuasive, brand-aligned copy for surfaces. Use for marketing/product copy. Positive: Rewrite homepage hero. Negative: Security penetration test.
---

# Copywriting

## Purpose
Write persuasive, brand-aligned copy for surfaces.

## Scope
In scope: Write persuasive, brand-aligned copy for surfaces.
...
- Capability ID: `skill.copywriting`
