---
name: product-analytics-planning
description: Define product analytics events and success metrics. Use for analytics instrumentation planning. Positive: Define events for onboarding. Negative: Negotiate vendor contract.
---

# Product Analytics Planning

## Purpose
Define product analytics events and success metrics.

## Scope
In scope: Define product analytics events and success metrics.
...
## Required context
- Department: `product`
- Capability ID: `skill.product-analytics-planning`
