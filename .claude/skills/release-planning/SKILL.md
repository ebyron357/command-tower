...
description: Plan product releases with audiences, risks, and comms. Use for product release plans. Positive: Plan beta release. Negative: Tune database indexes.
---

# Release Planning

## Purpose
Plan product releases with audiences, risks, and comms.

## Scope
In scope: Plan product releases with audiences, risks, and comms.
...
## Required context
- Department: `product`
- Capability ID: `skill.release-planning`
