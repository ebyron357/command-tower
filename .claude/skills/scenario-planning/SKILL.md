...
description: Create financial scenarios with sensitivities. Use for scenario planning. Positive: Best/base/worst cash scenarios. Negative: Fix CSS grid.
---

# Scenario Planning

## Purpose
Create financial scenarios with sensitivities.

## Scope
In scope: Create financial scenarios with sensitivities.
...
## Required context
- Department: `finance`
- Capability ID: `skill.scenario-planning`
...
## Positive examples
- Best/base/worst cash scenarios
