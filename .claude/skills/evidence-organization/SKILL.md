...
description: Organize compliance/legal evidence with chain of custody notes. Use for evidence organization. Positive: Organize audit evidence. Negative: Write marketing slogan.
---

# Evidence Organization

## Purpose
Organize compliance/legal evidence with chain of custody notes.

## Scope
In scope: Organize compliance/legal evidence with chain of custody notes.
...
- Capability ID: `skill.evidence-organization`
...
## Safety restrictions
- Not legal advice
- Escalate to qualified counsel for decisions
