...
description: Define crisp Given/When/Then and edge-case criteria. Use for acceptance criteria and DoD. Positive: AC for invite flow. Negative: Design color palette.
---

# Acceptance Criteria

## Purpose
Define crisp Given/When/Then and edge-case criteria.

## Scope
In scope: Define crisp Given/When/Then and edge-case criteria.
...
## Required context
- Department: `product`
- Capability ID: `skill.acceptance-criteria`
