...
description: Design training curricula with objectives and assessments. Use for training design. Positive: Security training curriculum. Negative: Negotiate lease.
---

# Training Development

## Purpose
Design training curricula with objectives and assessments.

## Scope
In scope: Design training curricula with objectives and assessments.
...
## Required context
- Department: `training`
- Capability ID: `skill.training-development`
