---
name: hiring-plans
description: Create hiring plans with leveling and capacity rationale. Use for hiring plans. Positive: Hiring plan for platform team. Negative: Style navbar.
---

# Hiring Plans

## Purpose
Create hiring plans with leveling and capacity rationale.

## Scope
In scope: Create hiring plans with leveling and capacity rationale.
...
- Capability ID: `skill.hiring-plans`
