...
description: Coordinate work across departments with RACI, interfaces, and handoffs. Use when multiple departments must collaborate on one initiative. Positive: Coordinate launch across eng/marketing/cs; Define RACI for migration. Negative: Refactor a single module.
---
...
## Scope
In scope: Coordinate work across departments with RACI, interfaces, and handoffs.
...
- Capability ID: `skill.cross-department-coordination`
