...
description: Assess customer health with signals, risks, plays. Use for health scoring/reviews. Positive: Customer health for Acme. Negative: Compile Rust.
---

# Customer Health

## Purpose
Assess customer health with signals, risks, plays.

## Scope
In scope: Assess customer health with signals, risks, plays.
...
- Capability ID: `skill.customer-health`
