---
name: design-systems
description: Extend or review design tokens, components, and usage rules. Use for design system work. Positive: Add toast component tokens. Negative: Close books for month.
---

# Design Systems

## Purpose
Extend or review design tokens, components, and usage rules.

## Scope
In scope: Extend or review design tokens, components, and usage rules.
...
## Required context
- Department: `design`
- Capability ID: `skill.design-systems`
