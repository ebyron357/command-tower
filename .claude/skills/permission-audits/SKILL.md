...
description: Audit permissions for least privilege and drift. Use for permission audits. Positive: Audit agent permissions. Negative: Write jingle.
---

# Permission Audits

## Purpose
Audit permissions for least privilege and drift.

## Scope
In scope: Audit permissions for least privilege and drift.
...
- Capability ID: `skill.permission-audits`
