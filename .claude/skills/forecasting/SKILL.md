---
name: forecasting
description: Build forecasts with scenarios and uncertainty ranges. Use for forecasting. Positive: Forecast MRR next 2 quarters. Negative: A11y icon audit.
---

# Forecasting

## Purpose
Build forecasts with scenarios and uncertainty ranges.

## Scope
In scope: Build forecasts with scenarios and uncertainty ranges.
...
- Capability ID: `skill.forecasting`
