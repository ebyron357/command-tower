...
description: Adversarial review of plans/systems for abuse paths. Use for red-team style reviews. Positive: Red-team the invite flow. Negative: Write invoice.
---

# Red Team Review

## Purpose
Adversarial review of plans/systems for abuse paths.

## Scope
In scope: Adversarial review of plans/systems for abuse paths.
...
- Capability ID: `skill.red-team-review`
