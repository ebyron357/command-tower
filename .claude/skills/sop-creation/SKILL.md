---
name: sop-creation
description: Create SOPs with steps, owners, and failure handling. Use for SOP creation. Positive: SOP for incident triage. Negative: Write love letter.
---

# Sop Creation

## Purpose
Create SOPs with steps, owners, and failure handling.

## Scope
In scope: Create SOPs with steps, owners, and failure handling.
...
- Capability ID: `skill.sop-creation`
