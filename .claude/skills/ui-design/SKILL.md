---
name: ui-design
description: Produce UI design direction with hierarchy, states, and specs. Use for UI design tasks. Positive: Design settings screen. Negative: File a patent claim.
---

# Ui Design

## Purpose
Produce UI design direction with hierarchy, states, and specs.

## Scope
In scope: Produce UI design direction with hierarchy, states, and specs.
