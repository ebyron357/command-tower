...
description: Aggregate department statuses into an executive snapshot with blockers and risks. Use when producing company status, standup rollups, or weekly exec updates. Positive: Company status this week; Aggregate department blockers. Negative: Design a logo.
---
...
## Scope
In scope: Aggregate department statuses into an executive snapshot with blockers and risks.
...
- Capability ID: `skill.status-aggregation`
