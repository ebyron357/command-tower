---
name: proposals
description: Draft proposals with scope, value, pricing framing, risks. Use for proposals/SOWs support. Positive: Draft proposal for analytics package. Negative: Implement OAuth.
---

# Proposals

## Purpose
Draft proposals with scope, value, pricing framing, risks.

## Scope
In scope: Draft proposals with scope, value, pricing framing, risks.
...
## Positive examples
- Draft proposal for analytics package
