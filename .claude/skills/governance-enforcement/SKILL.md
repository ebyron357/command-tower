...
description: Check governance docs/registries match implementation. Use for governance enforcement. Positive: Enforce registry consistency. Negative: Create meme.
---

# Governance Enforcement

## Purpose
Check governance docs/registries match implementation.

## Scope
In scope: Check governance docs/registries match implementation.
...
- Capability ID: `skill.governance-enforcement`
