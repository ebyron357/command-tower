...
description: Design performance frameworks with fair criteria. Use for performance frameworks. Positive: Design eng performance rubric. Negative: Fix CSS leak.
---

# Performance Frameworks

## Purpose
Design performance frameworks with fair criteria.

## Scope
In scope: Design performance frameworks with fair criteria.
...
- Capability ID: `skill.performance-frameworks`
