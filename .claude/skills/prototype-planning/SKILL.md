...
description: Plan prototypes with fidelity, questions, and success signals. Use for prototype plans. Positive: Plan clickable prototype. Negative: Rotate secrets.
---

# Prototype Planning

## Purpose
Plan prototypes with fidelity, questions, and success signals.

## Scope
In scope: Plan prototypes with fidelity, questions, and success signals.
...
## Required context
- Department: `design`
- Capability ID: `skill.prototype-planning`
