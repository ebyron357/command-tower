---
name: api-design
description: Design APIs with contracts, versioning, errors, auth, and examples. Use when designing REST/GraphQL/RPC APIs. Positive: Design the invoices API; Define error taxonomy. Negative: Write a job description.
---

# Api Design

## Purpose
Design APIs with contracts, versioning, errors, auth, and examples.

## Scope
In scope: Design APIs with contracts, versioning, errors, auth, and examples.
...
- Capability ID: `skill.api-design`
