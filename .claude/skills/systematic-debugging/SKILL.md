...
description: Debug defects with hypothesis, evidence, isolation, and regression tests. Use for bugs, failures, unexpected behavior. Positive: This endpoint 500s; Find the race condition. Negative: Plan a marketing campaign.
---

# Systematic Debugging

## Purpose
Debug defects with hypothesis, evidence, isolation, and regression tests.

## Scope
In scope: Debug defects with hypothesis, evidence, isolation, and regression tests.
...
- Capability ID: `skill.systematic-debugging`
