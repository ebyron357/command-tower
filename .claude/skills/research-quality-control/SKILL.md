---
name: research-quality-control
description: QA research outputs for sourcing and overclaiming. Use for research QC. Positive: QC this research brief. Negative: Implement CRUD.
---

# Research Quality Control

## Purpose
QA research outputs for sourcing and overclaiming.

## Scope
In scope: QA research outputs for sourcing and overclaiming.
...
## Required context
- Department: `research`
- Capability ID: `skill.research-quality-control`
