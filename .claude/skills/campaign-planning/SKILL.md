...
description: Plan campaigns with audience, channels, offers, KPIs. Use for campaign plans. Positive: Plan launch campaign. Negative: Refactor auth module.
---

# Campaign Planning

## Purpose
Plan campaigns with audience, channels, offers, KPIs.

## Scope
In scope: Plan campaigns with audience, channels, offers, KPIs.
...
- Capability ID: `skill.campaign-planning`
