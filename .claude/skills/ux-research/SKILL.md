---
name: ux-research
description: Plan and synthesize UX research with methods and bias controls. Use for UX research plans/synthesis. Positive: Plan usability study. Negative: Write SQL migration.
---

# Ux Research

## Purpose
Plan and synthesize UX research with methods and bias controls.

## Scope
In scope: Plan and synthesize UX research with methods and bias controls.
...
## Required context
- Department: `design`
- Capability ID: `skill.ux-research`
