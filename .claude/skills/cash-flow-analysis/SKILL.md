...
description: Analyze cash flow timing and runway risks. Use for cash-flow analysis. Positive: 13-week cash flow. Negative: Write e2e test.
---

# Cash Flow Analysis

## Purpose
Analyze cash flow timing and runway risks.

## Scope
In scope: Analyze cash flow timing and runway risks.
...
## Required context
- Department: `finance`
- Capability ID: `skill.cash-flow-analysis`
