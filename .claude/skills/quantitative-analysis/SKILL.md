...
description: Perform structured quantitative analysis with assumptions. Use for quantitative analyses. Positive: Analyze cohort retention. Negative: Create brand moodboard.
---

# Quantitative Analysis

## Purpose
Perform structured quantitative analysis with assumptions.

## Scope
In scope: Perform structured quantitative analysis with assumptions.
...
- Capability ID: `skill.quantitative-analysis`
