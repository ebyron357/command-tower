...
description: Plan releases with changelogs, rollback, and readiness checks. Use for release planning and cut criteria. Positive: Prepare v1.2 release; Write rollback plan. Negative: Customer health scoring.
---

# Release Engineering

## Purpose
Plan releases with changelogs, rollback, and readiness checks.

## Scope
In scope: Plan releases with changelogs, rollback, and readiness checks.
...
- Capability ID: `skill.release-engineering`
