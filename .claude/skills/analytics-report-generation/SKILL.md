...
description: Generate analytics reports with charts narrative and caveats. Use for analytics reports. Positive: Weekly growth report. Negative: Negotiate lease.
---

# Analytics Report Generation

## Purpose
Generate analytics reports with charts narrative and caveats.

## Scope
In scope: Generate analytics reports with charts narrative and caveats.
...
- Capability ID: `skill.analytics-report-generation`
