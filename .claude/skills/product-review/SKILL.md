---
name: product-review
description: Review product artifacts against user value and feasibility. Use for product critiques. Positive: Review this PRD. Negative: Generate Kubernetes manifests.
---

# Product Review

## Purpose
Review product artifacts against user value and feasibility.

## Scope
In scope: Review product artifacts against user value and feasibility.
...
## Required context
- Department: `product`
- Capability ID: `skill.product-review`
