---
name: qa-review
description: QA review for defects, coverage gaps, and release risk. Use for QA reviews. Positive: QA review release candidate. Negative: Draft brand manifesto.
---

# Qa Review

## Purpose
QA review for defects, coverage gaps, and release risk.

## Scope
In scope: QA review for defects, coverage gaps, and release risk.
