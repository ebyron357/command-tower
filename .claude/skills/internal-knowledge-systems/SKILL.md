...
description: Design internal enablement and knowledge systems. Use for enablement systems. Positive: Design internal academy. Negative: Bump lockfile.
---

# Internal Knowledge Systems

## Purpose
Design internal enablement and knowledge systems.

## Scope
In scope: Design internal enablement and knowledge systems.
...
## Required context
- Department: `training`
- Capability ID: `skill.internal-knowledge-systems`
