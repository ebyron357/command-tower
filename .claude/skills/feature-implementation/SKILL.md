...
description: Implement features with tests, incremental commits plan, and verification. Use when implementing product features in code. Positive: Implement the billing webhook; Add dark mode toggle. Negative: Create a budget forecast.
---

# Feature Implementation

## Purpose
Implement features with tests, incremental commits plan, and verification.

## Scope
In scope: Implement features with tests, incremental commits plan, and verification.
...
- Capability ID: `skill.feature-implementation`
