---
name: budgeting
description: Build budgets with drivers, assumptions, and variance framework. Use for budgeting support. Positive: Build eng budget. Negative: Write React hook.
---

# Budgeting

## Purpose
Build budgets with drivers, assumptions, and variance framework.

## Scope
In scope: Build budgets with drivers, assumptions, and variance framework.
