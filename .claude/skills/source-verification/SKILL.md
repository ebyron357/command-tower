...
description: Verify claims against primary sources and note confidence. Use when verifying claims/sources. Positive: Verify these market size claims. Negative: Write jest tests.
---

# Source Verification

## Purpose
Verify claims against primary sources and note confidence.

## Scope
In scope: Verify claims against primary sources and note confidence.
...
## Required context
- Department: `research`
- Capability ID: `skill.source-verification`
