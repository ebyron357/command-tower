...
description: Refactor with characterization tests, small steps, and behavior preservation. Use when restructuring code without changing behavior. Positive: Refactor the payment module; Extract service layer. Negative: Redesign the logo.
---

# Safe Refactoring

## Purpose
Refactor with characterization tests, small steps, and behavior preservation.

## Scope
In scope: Refactor with characterization tests, small steps, and behavior preservation.
...
- Capability ID: `skill.safe-refactoring`
