...
description: Write email sequences with goals, segments, and CTAs. Use for email marketing. Positive: Draft onboarding email sequence. Negative: Implement WebSocket.
---

# Email Marketing

## Purpose
Write email sequences with goals, segments, and CTAs.

## Scope
In scope: Write email sequences with goals, segments, and CTAs.
...
- Capability ID: `skill.email-marketing`
