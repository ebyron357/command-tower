...
description: Review accessibility against WCAG-oriented checks. Use for a11y reviews. Positive: A11y review this page. Negative: Write cold call script.
---

# Accessibility Review

## Purpose
Review accessibility against WCAG-oriented checks.

## Scope
In scope: Review accessibility against WCAG-oriented checks.
...
## Required context
- Department: `design`
- Capability ID: `skill.accessibility-review`
