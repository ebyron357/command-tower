...
description: Assess release readiness across quality, security, ops. Use for release readiness. Positive: Release readiness for v2. Negative:  invent customer logos.
---

# Release Readiness

## Purpose
Assess release readiness across quality, security, ops.

## Scope
In scope: Assess release readiness across quality, security, ops.
...
- Capability ID: `skill.release-readiness`
