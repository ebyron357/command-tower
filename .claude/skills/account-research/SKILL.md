...
description: Research accounts with org map, pains, and triggers. Use for account research. Positive: Research Acme Corp account. Negative: Write CSS.
---

# Account Research

## Purpose
Research accounts with org map, pains, and triggers.

## Scope
In scope: Research accounts with org map, pains, and triggers.
...
## Required context
- Department: `sales`
- Capability ID: `skill.account-research`
