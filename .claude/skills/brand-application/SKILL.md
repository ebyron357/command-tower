...
description: Apply brand rules to surfaces without diluting identity. Use for brand application reviews. Positive: Apply brand to docs site. Negative: Debug race condition.
---

# Brand Application

## Purpose
Apply brand rules to surfaces without diluting identity.

## Scope
In scope: Apply brand rules to surfaces without diluting identity.
...
## Required context
- Department: `design`
- Capability ID: `skill.brand-application`
