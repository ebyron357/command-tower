...
description: Apply distinctive, brand-safe frontend design guidance. Use when building frontend UI. Positive: Restyle the landing page. Negative: Create payroll forecast.
---

# Frontend Design

## Purpose
Apply distinctive, brand-safe frontend design guidance.

## Scope
In scope: Apply distinctive, brand-safe frontend design guidance.
...
## Required context
- Department: `design`
- Capability ID: `skill.frontend-design`
