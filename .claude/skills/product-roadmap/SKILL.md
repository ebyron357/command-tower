...
description: Build outcome-oriented roadmaps with sequencing and bets. Use for product roadmaps. Positive: Draft Q4 roadmap. Negative: Fix SQL injection.
---

# Product Roadmap

## Purpose
Build outcome-oriented roadmaps with sequencing and bets.

## Scope
In scope: Build outcome-oriented roadmaps with sequencing and bets.
...
## Required context
- Department: `product`
- Capability ID: `skill.product-roadmap`
