...
description: Spot legal issues and escalation needs—not legal advice. Use for issue spotting. Positive: Spot issues in this ToS draft. Negative: Optimize images.
---

# Legal Issue Spotting

## Purpose
Spot legal issues and escalation needs—not legal advice.

## Scope
In scope: Spot legal issues and escalation needs—not legal advice.
...
- Capability ID: `skill.legal-issue-spotting`
