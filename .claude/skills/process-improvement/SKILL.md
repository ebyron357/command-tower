...
description: Improve processes with waste analysis and pilots. Use for process improvement. Positive: Improve release process. Negative: Write poem.
---

# Process Improvement

## Purpose
Improve processes with waste analysis and pilots.

## Scope
In scope: Improve processes with waste analysis and pilots.
...
- Capability ID: `skill.process-improvement`
