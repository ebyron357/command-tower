---
name: deep-research
description: Conduct deep multi-source research with citation discipline. Use for deep research requests. Positive: Deep research on edge AI platforms. Negative: Rename CSS class.
---

# Deep Research

## Purpose
Conduct deep multi-source research with citation discipline.

## Scope
In scope: Conduct deep multi-source research with citation discipline.
...
## Required context
- Department: `research`
- Capability ID: `skill.deep-research`
