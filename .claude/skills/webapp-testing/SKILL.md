---
name: webapp-testing
description: Plan and execute local webapp testing with reconnaissance then action. Use for browser/webapp verification workflows. Positive: Test the signup flow; Capture console errors on checkout. Negative: Negotiate a contract.
---

# Webapp Testing

## Purpose
Plan and execute local webapp testing with reconnaissance then action.

## Scope
In scope: Plan and execute local webapp testing with reconnaissance then action.
...
- Capability ID: `skill.webapp-testing`
