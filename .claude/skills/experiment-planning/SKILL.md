...
description: Design experiments with hypothesis, metrics, and stop rules. Use for A/B and product experiments. Positive: Plan experiment for pricing page. Negative: Compile TypeScript.
---

# Experiment Planning

## Purpose
Design experiments with hypothesis, metrics, and stop rules.

## Scope
In scope: Design experiments with hypothesis, metrics, and stop rules.
...
## Required context
- Department: `product`
- Capability ID: `skill.experiment-planning`
...
## Positive examples
- Plan experiment for pricing page
