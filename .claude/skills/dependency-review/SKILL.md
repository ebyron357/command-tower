...
description: Review dependencies for risk, license, pinning, and alternatives. Use when adding/updating packages or auditing deps. Positive: Review these npm packages; Should we add library X?. Negative: Write onboarding email.
---

# Dependency Review

## Purpose
Review dependencies for risk, license, pinning, and alternatives.

## Scope
In scope: Review dependencies for risk, license, pinning, and alternatives.
...
- Capability ID: `skill.dependency-review`
