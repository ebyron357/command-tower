---
name: creative-brief
description: Write creative briefs with audience, message, constraints. Use for creative briefs. Positive: Brief for launch video. Negative: Tune JVM heap.
---

# Creative Brief

## Purpose
Write creative briefs with audience, message, constraints.

## Scope
In scope: Write creative briefs with audience, message, constraints.
...
- Capability ID: `skill.creative-brief`
