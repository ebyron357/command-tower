...
description: Identify, classify, and escalate cross-cutting risks with owners and mitigations. Use when risks need escalation paths, severity, and owners. Positive: Escalate production risk; Create risk register entry. Negative: Write SEO metadata.
---
...
## Scope
In scope: Identify, classify, and escalate cross-cutting risks with owners and mitigations.
...
- Capability ID: `skill.risk-escalation`
