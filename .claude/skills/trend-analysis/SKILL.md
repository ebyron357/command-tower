---
name: trend-analysis
description: Analyze trends with time horizon and weak-signal discipline. Use for trend analysis. Positive: Trends in agentic tooling. Negative: Fix CSS bug.
---

# Trend Analysis

## Purpose
Analyze trends with time horizon and weak-signal discipline.

## Scope
In scope: Analyze trends with time horizon and weak-signal discipline.
...
## Required context
- Department: `research`
- Capability ID: `skill.trend-analysis`
