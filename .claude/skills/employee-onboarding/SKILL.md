...
description: Design employee onboarding journeys and checklists. Use for employee onboarding design. Positive: 30-60-90 onboarding plan. Negative: Write regex.
---

# Employee Onboarding

## Purpose
Design employee onboarding journeys and checklists.

## Scope
In scope: Design employee onboarding journeys and checklists.
...
- Capability ID: `skill.employee-onboarding`
