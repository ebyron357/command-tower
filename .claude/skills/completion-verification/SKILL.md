...
description: Verify completion claims with evidence gates. Use for completion verification. Positive: Verify wave 7 complete. Negative: Brainstorm slogans.
---

# Completion Verification

## Purpose
Verify completion claims with evidence gates.

## Scope
In scope: Verify completion claims with evidence gates.
...
- Capability ID: `skill.completion-verification`
