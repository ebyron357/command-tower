...
description: Onboard Claude and humans to an unfamiliar repository with architecture map and risks. Use when onboarding to a new or unfamiliar codebase. Positive: Onboard me to this repo; Map the architecture. Negative: Write a sales email.
---

# Repo Onboarding

## Purpose
Onboard Claude and humans to an unfamiliar repository with architecture map and risks.

## Scope
In scope: Onboard Claude and humans to an unfamiliar repository with architecture map and risks.
...
- Capability ID: `skill.repo-onboarding`
