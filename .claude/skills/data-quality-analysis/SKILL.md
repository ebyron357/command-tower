...
description: Assess data quality dimensions and remediation plan. Use for data quality work. Positive: Assess CRM data quality. Negative: Write jingle.
---

# Data Quality Analysis

## Purpose
Assess data quality dimensions and remediation plan.

## Scope
In scope: Assess data quality dimensions and remediation plan.
...
- Capability ID: `skill.data-quality-analysis`
