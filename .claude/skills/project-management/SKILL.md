...
description: Plan projects with milestones, risks, and status cadence. Use for PM planning/status. Positive: Plan migration project. Negative: Generate favicon.
---

# Project Management

## Purpose
Plan projects with milestones, risks, and status cadence.

## Scope
In scope: Plan projects with milestones, risks, and status cadence.
...
- Capability ID: `skill.project-management`
