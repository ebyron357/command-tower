...
description: Design or review system architecture with constraints, ADRs, and trade-offs. Use for architecture design, ADRs, or system design reviews. Positive: Design the auth architecture; Write an ADR. Negative: Draft a press release.
---

# Technical Architecture

## Purpose
Design or review system architecture with constraints, ADRs, and trade-offs.

## Scope
In scope: Design or review system architecture with constraints, ADRs, and trade-offs.
...
- Capability ID: `skill.technical-architecture`
