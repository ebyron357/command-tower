...
description: Prepare objection responses with proof and questions. Use for objection handling. Positive: Handle price objection. Negative: Write Terraform.
---

# Objection Handling

## Purpose
Prepare objection responses with proof and questions.

## Scope
In scope: Prepare objection responses with proof and questions.
...
## Required context
- Department: `sales`
- Capability ID: `skill.objection-handling`
