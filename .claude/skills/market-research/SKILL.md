...
description: Research markets, segments, and demand with sourced claims. Use for market research. Positive: Research SMB payroll market. Negative: Fix flaky e2e.
---

# Market Research

## Purpose
Research markets, segments, and demand with sourced claims.

## Scope
In scope: Research markets, segments, and demand with sourced claims.
...
- Capability ID: `skill.market-research`
