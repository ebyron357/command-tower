---
name: social-media
description: Plan social content with channel norms and brand voice. Use for social plans/posts. Positive: Plan LinkedIn cadence. Negative: Design DB indexes.
---

# Social Media

## Purpose
Plan social content with channel norms and brand voice.

## Scope
In scope: Plan social content with channel norms and brand voice.
...
- Capability ID: `skill.social-media`
