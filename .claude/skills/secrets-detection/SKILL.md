...
description: Detect credential-like strings and secret handling risks. Use for secrets scanning workflows. Positive: Scan for secrets. Negative: Design poster.
---

# Secrets Detection

## Purpose
Detect credential-like strings and secret handling risks.

## Scope
In scope: Detect credential-like strings and secret handling risks.
...
- Capability ID: `skill.secrets-detection`
