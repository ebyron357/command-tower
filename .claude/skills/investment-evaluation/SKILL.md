...
description: Evaluate investments with ROI/NPV framing and risks. Use for investment evaluation. Positive: Evaluate infra investment. Negative: Write tweet thread.
---

# Investment Evaluation

## Purpose
Evaluate investments with ROI/NPV framing and risks.

## Scope
In scope: Evaluate investments with ROI/NPV framing and risks.
...
## Required context
- Department: `finance`
- Capability ID: `skill.investment-evaluation`
