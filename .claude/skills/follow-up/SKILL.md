---
name: follow-up
description: Write follow-ups that advance next steps without pressure spam. Use for sales follow-ups. Positive: Follow up after demo. Negative: Configure CDN.
---

# Follow Up

## Purpose
Write follow-ups that advance next steps without pressure spam.

## Scope
In scope: Write follow-ups that advance next steps without pressure spam.
