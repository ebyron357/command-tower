...
description: Review supply chain: deps, scripts, provenance. Use for supply-chain reviews. Positive: Supply-chain review of install scripts. Negative: Write welcome email.
---

# Supply Chain Review

## Purpose
Review supply chain: deps, scripts, provenance.

## Scope
In scope: Review supply chain: deps, scripts, provenance.
...
- Capability ID: `skill.supply-chain-review`
...
## Positive examples
- Supply-chain review of install scripts
