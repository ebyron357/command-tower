...
description: Analyze experiments with validity threats and decisions. Use for experiment analysis. Positive: Analyze pricing A/B. Negative: Write Dockerfile.
---

# Experiment Analysis

## Purpose
Analyze experiments with validity threats and decisions.

## Scope
In scope: Analyze experiments with validity threats and decisions.
...
- Capability ID: `skill.experiment-analysis`
