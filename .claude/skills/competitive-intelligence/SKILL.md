...
description: Build competitor landscapes with evidence and gaps. Use for competitive intelligence. Positive: CI brief on top 3 rivals. Negative: Format markdown.
---

# Competitive Intelligence

## Purpose
Build competitor landscapes with evidence and gaps.

## Scope
In scope: Build competitor landscapes with evidence and gaps.
...
## Required context
- Department: `research`
- Capability ID: `skill.competitive-intelligence`
