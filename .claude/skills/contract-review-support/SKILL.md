...
description: Support contract review with clause checklist and questions. Use for contract review support. Positive: Review NDA checklist. Negative: Write CSS animation.
---

# Contract Review Support

## Purpose
Support contract review with clause checklist and questions.

## Scope
In scope: Support contract review with clause checklist and questions.
...
- Capability ID: `skill.contract-review-support`
