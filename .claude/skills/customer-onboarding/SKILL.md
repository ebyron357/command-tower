...
description: Design customer onboarding journeys and success milestones. Use for CS onboarding design. Positive: Design onboarding for enterprise. Negative: Optimize SQL.
---

# Customer Onboarding

## Purpose
Design customer onboarding journeys and success milestones.

## Scope
In scope: Design customer onboarding journeys and success milestones.
...
- Capability ID: `skill.customer-onboarding`
...
## Positive examples
- Design onboarding for enterprise
