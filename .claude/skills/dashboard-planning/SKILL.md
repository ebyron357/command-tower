...
description: Plan dashboards with audience, questions, and definitions. Use for dashboard planning. Positive: Plan exec dashboard. Negative: Write Rust FFI.
---

# Dashboard Planning

## Purpose
Plan dashboards with audience, questions, and definitions.

## Scope
In scope: Plan dashboards with audience, questions, and definitions.
...
- Capability ID: `skill.dashboard-planning`
