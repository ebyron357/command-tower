...
description: Track regulatory changes with jurisdiction tags. Use for regulatory tracking. Positive: Track AI disclosure rules. Negative: Bump eslint.
---

# Regulatory Tracking

## Purpose
Track regulatory changes with jurisdiction tags.

## Scope
In scope: Track regulatory changes with jurisdiction tags.
...
- Capability ID: `skill.regulatory-tracking`
