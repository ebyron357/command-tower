...
description: Critique visual quality, hierarchy, and polish. Use for visual QA. Positive: Visual review homepage. Negative: Implement OAuth.
---

# Visual Quality Review

## Purpose
Critique visual quality, hierarchy, and polish.

## Scope
In scope: Critique visual quality, hierarchy, and polish.
...
## Required context
- Department: `design`
- Capability ID: `skill.visual-quality-review`
