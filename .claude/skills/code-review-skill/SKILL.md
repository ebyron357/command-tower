...
description: Review diffs for correctness, security, maintainability, and missing tests. Use when reviewing PRs or local diffs. Positive: Review this PR; Code review the auth change. Negative: Write Instagram captions.
---

# Code Review Skill

## Purpose
Review diffs for correctness, security, maintainability, and missing tests.

## Scope
In scope: Review diffs for correctness, security, maintainability, and missing tests.
...
- Capability ID: `skill.code-review-skill`
