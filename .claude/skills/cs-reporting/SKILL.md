---
name: cs-reporting
description: Produce CS reports with retention, health, and actions. Use for CS reporting. Positive: Weekly CS report. Negative: Design animation.
---

# Cs Reporting

## Purpose
Produce CS reports with retention, health, and actions.

## Scope
In scope: Produce CS reports with retention, health, and actions.
...
- Capability ID: `skill.cs-reporting`
