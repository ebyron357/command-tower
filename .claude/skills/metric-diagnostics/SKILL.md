...
description: Diagnose metric movements with decomposition. Use when a metric moved unexpectedly. Positive: Why did conversion drop?. Negative: Style a button.
---

# Metric Diagnostics

## Purpose
Diagnose metric movements with decomposition.

## Scope
In scope: Diagnose metric movements with decomposition.
...
- Capability ID: `skill.metric-diagnostics`
