...
description: Prepare financial narrative reports with caveats. Use for financial reporting support. Positive: Monthly finance narrative. Negative: Ship Docker image.
---

# Financial Reporting

## Purpose
Prepare financial narrative reports with caveats.

## Scope
In scope: Prepare financial narrative reports with caveats.
...
## Required context
- Department: `finance`
- Capability ID: `skill.financial-reporting`
