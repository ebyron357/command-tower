...
description: Analyze policies for gaps, conflicts, and controls. Use for policy analysis. Positive: Analyze security policy gaps. Negative: Design logo mark.
---

# Policy Analysis

## Purpose
Analyze policies for gaps, conflicts, and controls.

## Scope
In scope: Analyze policies for gaps, conflicts, and controls.
...
- Capability ID: `skill.policy-analysis`
