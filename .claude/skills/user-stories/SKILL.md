---
name: user-stories
description: Create user stories with personas, flows, and acceptance hooks. Use when writing user stories. Positive: Write stories for checkout. Negative: Rotate API keys.
---

# User Stories

## Purpose
Create user stories with personas, flows, and acceptance hooks.

## Scope
In scope: Create user stories with personas, flows, and acceptance hooks.
...
## Required context
- Department: `product`
- Capability ID: `skill.user-stories`
