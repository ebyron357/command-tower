...
description: Generate meaningful unit/integration/e2e tests with failure cases. Use when creating or expanding automated tests. Positive: Generate tests for CheckoutService; Add negative path tests. Negative: Create a pitch deck.
---

# Test Generation

## Purpose
Generate meaningful unit/integration/e2e tests with failure cases.

## Scope
In scope: Generate meaningful unit/integration/e2e tests with failure cases.
...
- Capability ID: `skill.test-generation`
