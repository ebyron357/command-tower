...
description: Design schemas, migrations, indexes, and data integrity rules. Use for schema design, migrations, indexing strategy. Positive: Design users and orgs schema; Plan zero-downtime migration. Negative: SEO keyword research.
---

# Database Design

## Purpose
Design schemas, migrations, indexes, and data integrity rules.

## Scope
In scope: Design schemas, migrations, indexes, and data integrity rules.
...
- Capability ID: `skill.database-design`
