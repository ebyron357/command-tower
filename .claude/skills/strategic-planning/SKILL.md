...
description: Produce multi-horizon strategic plans with options, trade-offs, and decision criteria. Use when planning strategy, OKRs, initiative portfolios, or quarterly direction. Positive: Create a 90-day strategy; Draft OKRs for engineering. Negative: Implement a React component; Fix a failing unit test.
---
...
## Scope
In scope: Produce multi-horizon strategic plans with options, trade-offs, and decision criteria.
...
- Capability ID: `skill.strategic-planning`
...
## Positive examples
- Create a 90-day strategy
- Draft OKRs for engineering
- Prioritize company initiatives
