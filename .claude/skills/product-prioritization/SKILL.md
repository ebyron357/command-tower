...
description: Prioritize using RICE/WSJF/custom scoring with evidence. Use for prioritization sessions. Positive: Prioritize these epics. Negative: Write payroll policy.
---

# Product Prioritization

## Purpose
Prioritize using RICE/WSJF/custom scoring with evidence.

## Scope
In scope: Prioritize using RICE/WSJF/custom scoring with evidence.
...
## Required context
- Department: `product`
- Capability ID: `skill.product-prioritization`
