...
description: Review content performance and recommend iterations. Use for content performance reviews. Positive: Review blog performance. Negative: Create Kubernetes chart.
---

# Content Performance

## Purpose
Review content performance and recommend iterations.

## Scope
In scope: Review content performance and recommend iterations.
...
- Capability ID: `skill.content-performance`
