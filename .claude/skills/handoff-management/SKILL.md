...
description: Create operational handoffs with ownership and open risks. Use for handoffs. Positive: Create sprint handoff. Negative: Generate JWT.
---

# Handoff Management

## Purpose
Create operational handoffs with ownership and open risks.

## Scope
In scope: Create operational handoffs with ownership and open risks.
...
- Capability ID: `skill.handoff-management`
