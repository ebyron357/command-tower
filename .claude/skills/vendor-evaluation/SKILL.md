...
description: Evaluate vendors with requirements, risks, and TCO. Use for vendor evaluation. Positive: Evaluate CRM vendors. Negative: Fix TypeScript error.
---

# Vendor Evaluation

## Purpose
Evaluate vendors with requirements, risks, and TCO.

## Scope
In scope: Evaluate vendors with requirements, risks, and TCO.
...
- Capability ID: `skill.vendor-evaluation`
