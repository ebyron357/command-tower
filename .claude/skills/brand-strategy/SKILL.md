---
name: brand-strategy
description: Define brand strategy, personality, and narrative. Use for brand strategy. Positive: Draft brand strategy brief. Negative: Write unit tests.
---

# Brand Strategy

## Purpose
Define brand strategy, personality, and narrative.

## Scope
In scope: Define brand strategy, personality, and narrative.
...
- Capability ID: `skill.brand-strategy`
