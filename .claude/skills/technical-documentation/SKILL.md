...
description: Write accurate technical docs from code and verified behavior. Use when documenting systems, APIs, runbooks. Positive: Document the auth flow; Write runbook for incidents. Negative: Create ad creatives.
---

# Technical Documentation

## Purpose
Write accurate technical docs from code and verified behavior.

## Scope
In scope: Write accurate technical docs from code and verified behavior.
...
- Capability ID: `skill.technical-documentation`
