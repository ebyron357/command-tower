---
name: meeting-prep
description: Prepare meeting briefs with goals, risks, and asks. Use for meeting prep. Positive: Prep QBR meeting. Negative: Bump dependency versions.
---

# Meeting Prep

## Purpose
Prepare meeting briefs with goals, risks, and asks.

## Scope
In scope: Prepare meeting briefs with goals, risks, and asks.
...
## Required context
- Department: `sales`
- Capability ID: `skill.meeting-prep`
