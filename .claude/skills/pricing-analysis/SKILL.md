...
description: Analyze pricing options with willingness-to-pay proxies. Use for pricing analysis. Positive: Analyze seat vs usage pricing. Negative: Lint Python.
---

# Pricing Analysis

## Purpose
Analyze pricing options with willingness-to-pay proxies.

## Scope
In scope: Analyze pricing options with willingness-to-pay proxies.
...
## Required context
- Department: `finance`
- Capability ID: `skill.pricing-analysis`
